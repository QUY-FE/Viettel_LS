...
const ProductPage = () => {
  ...
  const breadcrumbItems = [{ label: "Sản phẩm dịch vụ", href: "/products" }];
  return (
    <>
      <div className="max-w-7xl mx-auto min-h-screen px-2 sm:px-6 lg:px-8">
              ...
              >
                ...
                <ul className="space-y-3 mb-6 text-sm text-[#44494D]">
                  <li className="flex items-center">
                    <Zap size={16} className="text-green-500 mr-2" /> Băng thông
                    tối thiểu: {150 + i * 100} Mbps
                  </li>
                  <li className="flex items-center">
            ...
            {["V90B", "MXH120", "V200B", "5G150"].map((plan, i) => (
              ...
              >
                ...
                <ul className="space-y-2 mb-6 text-sm text-[#44494D]">
                  <li>
                    • <span className="font-bold">{1 + i}GB/Ngày</span> Data tốc
                    độ cao
                  </li>
              ...
              <div key={i} className="bg-white group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl mb-1 lg:mb-4 h-56">
                  <Image
                    ...
                    priority={i < 2}
                  />
                  <div className="absolute top-2 right-4 bg-primary text-white text-xs font-bold px-3 py-1 rounded-tl-lg rounded-br-lg uppercase tracking-wider">
                    {news.tag}
                  </div>
                </div>
                <h3 className="text-lg lg:text-xl font-bold text-black line-clamp-2">
                  {news.title}
                </h3>
