            ...
            {[
              ...
              >
                ...
                <div className="border-t border-gray-100 pt-4">
                  ...
                  <button className="w-full bg-[#EE0033] text-white py-2 rounded-xl font-medium hover:bg-red-700 transition-colors">
                    Đăng ký mua
                  </button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {["V90B", "MXH120", "V200B", "5G150"].map((plan, i) => (
              ...
              >
                ...
                <button className="w-full border border-[#EE0033] text-[#EE0033] group-hover:bg-[#EE0033] group-hover:text-white py-2 rounded-xl font-medium transition-colors">
                  Đăng ký
                </button>
              </div>
            ))}
